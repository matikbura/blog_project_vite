<template>
 <div v-infinite-scroll="test">
   <div class="divide-y divide-gray-200  px-3 overflow-y-auto"   style="height: 800px">
     ...
     <div class="h-20 items-center" v-if="isLoad" v-loading="isLoad">
     </div>
...
const data = ref<Pages<Article>>({
  page: 1,queryParams: {uid:$user.user.uid,status:1} as Article,rows: [],  size: 10,
})
onMounted(()=>{
  //初始化 获取所有 文章属于自己的
  isLoad.value=true
